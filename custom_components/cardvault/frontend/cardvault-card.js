            ...
            <div class="dialog-overlay" @click=${this._handleOverlayClick}>
                <div class="dialog">
                    ...
                    <div class="dialog-body">
                        ...
                        ${this._hasFront||this._hasBack?F`
                                  <div class="form-group">
                        ...
                        `:"compact"===e?F`
                          ...
                          `:F`
                              <div class="card-grid" style=${n}>
                                  ${this._cards.map(t=>{const e="front"===t.tile_background&&t.image_front?t.image_front:"back"===t.tile_background&&t.image_back?t.image_back:null,r=e?`background:${t.color||"#607D8B"} url(/cardvault/images/${e}) center/cover`:`background:${t.color||"#607D8B"}`;return F`
                                              <div
                                                  class="card-tile"
                                                  style=${r}
                                                  @click=${()=>this._handleCardClick(t)}
